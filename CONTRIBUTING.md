# Contributing to react-colorpickr
...
3. **Open a PR**, get it reviewed and merged to `publisher-production`
4. **Trigger the release** from the [Actions tab](../../actions/workflows/npm-release.yml):
   - Select **NPM release** → **Run workflow** → run from `publisher-production`
